...
void showUserManagementDialog({required BuildContext context}) {
  showDialog(
    context: context,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text("Sarah Jahan", style: bodyLarge()),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(user.journalCount.toString(), style: titleSmall()),
                              ],
                            ),
                          ],
                        ),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(user.favoriteCount.toString(), style: bodyMedium(color: customGrey)),
                              ],
                            ),
                          ),
                        ),
